---
title: Cycle Frequencies
hide_title: true
description: Cycle through a list of frequencies.
---
...
<ScriptPageHeader
  title="Cycle Frequencies"
  summary="Cycle through a list of frequencies."
  installLabel="Install Cycle Frequencies"
...
This task will cycle through a list of frequencies.  Each time it is run, it
will advance to the next frequency.
...
<TabItem value="source">
	### Source
	<RemoteCode language="js" scriptLibraryFile="cycle-freqs.js" />
</TabItem>
